...
public class EditTourController extends HttpServlet {
    ...
    private static final String SUCCESS = "update_tour.jsp";
    private static final String INVALID = "SearchTourController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!dao.checkIfTourInTicket(tourId)) {
                TourDTO dto = dao.findByTourId(tourId);
                url = SUCCESS;
                request.setAttribute("DTO", dto);
            } else {
                url = INVALID;
                request.setAttribute("INVALID", "Tour has been in Ticket");
            }
        } catch (Exception e) {
