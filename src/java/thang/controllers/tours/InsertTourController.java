...
public class InsertTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String imgUrl = "img" + File.separator + filePart.getSubmittedFileName();
            //Validation
            ...
            if (valid) {
                TourDTO dto = new TourDTO(tourName, tourOrigin, tourDes, Integer.parseInt(tourDurationStr), description, imgUrl);
