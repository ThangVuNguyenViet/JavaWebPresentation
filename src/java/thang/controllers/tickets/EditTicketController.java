...
public class EditTicketController extends HttpServlet {
    ...
    private static final String INVALID = "SearchTicketController";
    private static final String SUCCESS = "update_ticket.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!dao.checkIfTicketAlreadyBooked(ticketId)) {
                TicketDTO dto = dao.findByTicketId(ticketId);
                url = SUCCESS;
                request.setAttribute("DTO", dto);
            } else {
                url = INVALID;
                request.setAttribute("INVALID", "This ticket has already been booked");
            }
        } catch (Exception e) {
